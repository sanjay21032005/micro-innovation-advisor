  ...
  return (
    <div className={`bg-slate-50 border-r border-slate-200 flex flex-col transition-all duration-300 ${isOpen ? 'w-64 translate-x-0' : 'w-0 -translate-x-full opacity-0 md:opacity-100 md:w-0 md:-translate-x-full overflow-hidden'} ${className}`}>
      ...
      <div className="flex-1 overflow-y-auto px-3 py-2 custom-scrollbar">
        <div className="mb-4">
          <h3 className="text-[10px] font-bold text-slate-400 px-2 mb-2 uppercase tracking-widest">Recent</h3>
          <div className="space-y-1">
            <button className="w-full text-left px-3 py-2 rounded-lg hover:bg-slate-200/50 text-sm text-slate-700 truncate transition-colors flex items-center gap-2">
